...
<style>
    ...
    <section class="text-light p-5 px-1 pt-md-5 text-center d-none d-md-none d-lg-block d-xl-block" style="background: pink">
    ...
    <section class="text-light p-5 text-center d-none d-md-none d-lg-block d-xl-block" style="background: #5e51a2">
    <div><h1 class="p-3">The ARW Elite Finalists</h1>
    <div class="container">

            <div class="row justify-content-center">
                <div class="col px-4">
                    <div class="row pt-4"><div class="container bg-info rounded-5" style="height: 44vh; width: 23vh"></div></div>
    ...
    <!-- Third Sec -->
    <section class="text-dark p-5 text-center d-none d-md-none d-lg-block d-xl-block" style="background: pink">
    ...
    <!-- First Sec Mobile ver -->

    <section class="text-light p-5 px-1 pt-md-5 text-center d-block d-sm-block d-md-blpck d-lg-none d-xl-none" style="background: pink">
    <div class="container custom-bg-green p-sm-0 my-2 rounded-4">
        <div class="p-3">
                <h1 class="pt-4">The ARW Elite</h1>
                <p class="text-class lead px-2" style="font-family:Garamond">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque malesuada ipsum sit amet leo interdum, vitae maximus turpis pharetra. 
                Etiam lobortis nibh sed gravida condimentum. Maecenas luctus congue commodo. Aliquam volutpat nisi ac purus semper, vitae auctor elit hendrerit. 
                Donec ac mauris a nunc tempor mollis. Praesent finibus, ligula vitae tincidunt dignissim, risus ante dictum sapien, et condimentum nibh nulla vitae nunc. 
                Etiam quis placerat tortor. Donec venenatis, ipsum at vehicula molestie, risus dolor pellentesque mi, eu pharetra magna neque ac metus. 
    ...
    <!-- Second Sec Mobile ver-->

    <section class="text-light p-1 text-center d-block d-sm-block d-md-block d-lg-none d-xl-none" style="background: #5e51a2">
    <div><h1 class="p-3">The ARW Elite Finalists</h1>
    <div class="container">

    <div class="row justify-content-center">
                <div class="col px-4">
                    <div class="row pt-4"><div class="container bg-info rounded-5" style="height: 40vh; width: 19vh"></div></div>
                        <div class="row py-4"><div class="container bg-info rounded-4" style="height: 75px; width: 19vh">
                            <h5 class="pt-2" style="font-family:Garamond">ELITE NAME</p>
                            <h5 class="pb-5" style="font-family:Garamond; font-weight:bold">ORG NAME</p>
                        </div>
                    </div>
    ...
    <!-- Third Sec -->
    <section class="text-dark p-2 text-center d-block d-sm-block d-md-block d-lg-none d-xl-none" style="background: pink">
    ...
    <div class="row justify-content-center">
                <div class="col px-4">
                    <div class="row pt-4"><div class="container bg-light rounded-5" style="height: 40vh; width: 19vh"></div></div>
                </div>
                ...
                <div class="col pb-4 text-center justify-content-center">
                        <h1 class="pt-4" style="font-family:Garamond">ORG FULL NAME</h1>
                        <h3 class="" style="font-family:Garamond">ORG NAME</h3>
                        <h2 class="" style="font-family:Garamond">ELITE NAME</h2>
                        <div class="container bg-light" style="height: 50vw; width: 75vw"></div>
                </div>
    </section>

    <!-- Fourth Sec (same as third sec for mobile)-->
    <section class="text-light p-2 text-center d-block d-sm-block d-md-block d-lg-none d-xl-none" style="background: #5e51a2">
    ...
    <!-- LAST SEC -->
    <section class="text-light p-5 px-1 pt-md-5 text-center d-block d-sm-block d-md-block d-lg-none d-xl-none" style="background: pink">
        <div class="justify-content-center">
            <h1 class="p-3 text-dark">Who will be the ultimate ARW Elite?</h1>
